...
import { idlFactory } from './Balance.did.js';
export { idlFactory } from './Balance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BALANCE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Balance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Balance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Balance.did.js")._SERVICE>}
 */
export const Balance = createActor(canisterId);
